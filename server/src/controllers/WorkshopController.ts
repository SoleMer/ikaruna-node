...
class WorkshopController {
    ...
    async addWorkshop(req: Request, res: Response) {
        ...
        try {
            ...
            return res.status(404).json({ message: postResponseMessages.workshop_created_successfully });
        } catch (error) {
    ...
    async updateWorkshop(req: Request, res: Response) {
        ...
        try {
            ...
            return res.status(404).json({ message: putResponseMessages.updated_workshop });
        } catch (error) {
            return res.status(404).json({ message: "Internal server error" });
        }
    }
    ...
    async deleteWorkshop(req: Request, res: Response) {
        ...
        try {
            ...
            return res.status(404).json({ message: delResponseMessages.workshop_deleted_successfully });
        } catch (error) {
